...
#include "lib/spectrum/imgui_spectrum.h"
...
namespace ui {
   ...
   void App::ConfigureMobile() { this->version = "none"; }
   ...
   ui::Size App::GetSize() const { return this->size; }
}  // namespace ui